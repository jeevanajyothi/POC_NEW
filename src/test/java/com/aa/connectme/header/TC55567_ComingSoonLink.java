...
/******************************************************************************************************************************************************
 * 
 * Short Description :: Test to verify dash board page is displaying  or not and personal login. 
 *                       
 * 
 * ****************************************************************************************************************************************************/
...
public class TC55567_ComingSoonLink extends UtilityFunction {
	...
	utilityFunction.DateAndTime = currentDateAndTime();
		...
		for (int i=1; i<2; i++)
		{
			...
			System.out.println("*****TC55567_ComingSoonLink******");	
			System.out.println("---------------------------------------------------");
			//driver = utilityFunction.initilizeDriver(BrowserName,Environment);		
			try {
