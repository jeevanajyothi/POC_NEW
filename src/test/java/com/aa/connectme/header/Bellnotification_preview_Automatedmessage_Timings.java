...
public class Bellnotification_preview_Automatedmessage_Timings extends UtilityFunction {
	...
	public void Test(String BrowserName, String Environment, String TestResult) throws Exception {
		...
		for (int i = 1; i < 2; i++) {
			...
			System.out.println("*****Bellnotification_preview_Automatedmessage_Timings******");
			System.out.println("------------------------------------------------------------");
			try {
