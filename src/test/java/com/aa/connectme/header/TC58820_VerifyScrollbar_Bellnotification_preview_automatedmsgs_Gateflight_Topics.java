...
public class TC58820_VerifyScrollbar_Bellnotification_preview_automatedmsgs_Gateflight_Topics extends UtilityFunction {
	...
	public void Test(String BrowserName, String Environment, String TestResult) throws Exception {
		...
		for (int i = 1; i < 2; i++) {
			...
			System.out.println("*****TC58820_VerifyScrollbar_Bellnotification_preview_automatedmsgs_Gateflight_Topics******");
			System.out.println("-------------------------------------------------------------------");
			try {
				...
				if (dashboardPage.getListOfMesFromNotificationTab() == true) {
					...
					ExtentTest childTest1 = parentTest
							.createNode("STEP 10 - Acknowledge messages", "Priority message count matches")
				...
				if (dashboardPage.getMesTopicFromNotificationTab() == true) {
					...
					ExtentTest childTest1 = parentTest
							.createNode("STEP 11 - Get message topic",
					...
					ExtentTest childTest1 = parentTest
							.createNode("STEP 11 - Get message topic", "There were no messages as of now.")
