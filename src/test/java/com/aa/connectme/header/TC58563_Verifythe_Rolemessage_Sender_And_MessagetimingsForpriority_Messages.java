...
public class TC58563_Verifythe_Rolemessage_Sender_And_MessagetimingsForpriority_Messages extends UtilityFunction{
    WebDriver driver;
	...
	public void Test(String BrowserName, String Environment, String TestResult) throws Exception {
		...
		for (int i = 1; i < 2; i++) {
			...
			System.out.println("*****TC58563_Verifythe_Rolemessage_Sender_And_MessagetimingsForpriority_Messages******");
			System.out.println("--------------------------------------------------------------------------------------");
			try {
				...
				if (dashboardPage.getRolesFromNotificationTab() == true) {
					...
					ExtentTest childTest1 = parentTest
							.createNode("STEP 11 - GetRoles", "Notification message with Roless displayed")
