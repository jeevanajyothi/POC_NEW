...
public class TC60378_Verify_once_flight_out_from_gate_receiving_OUT_banner_with_grey_color extends UtilityFunction
{
	...
	public void Test(String BrowserName, String Environment,String TestResult) throws Exception {	
		...
		System.out.println("The number of rows present on the "+"GetNGCredentials"+" is = "+intLoop);
			...
			try {
				...
				Thread.sleep(5000);
				if(DP.changeGateBasedonGetngResults("DFW")==true)
				{
