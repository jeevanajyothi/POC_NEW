...
public class TC60379_Verify_once_my_current_flight_OUT_next_flight_moves_into_currentflight_panel extends UtilityFunction
{
	...
	public void Test(String BrowserName, String Environment,String TestResult) throws Exception {	
		...
		System.out.println("The number of rows present on the "+"GetNGCredentials"+" is = "+intLoop);
			...
			try {
				...
				Thread.sleep(5000);
				if(DP.verifyNextFlightMovedToCurrentThread("DFW")==true)
				{
					System.out.println("Verified the flight banner for OUT/OFF status.");
					...
					System.out.println("Failed to Verify the flight banner for OUT/OFF status");
